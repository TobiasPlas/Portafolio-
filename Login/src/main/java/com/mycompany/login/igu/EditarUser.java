...
public class EditarUser extends javax.swing.JFrame {
    ...
    Usuario user;
    String usuario1;
    public EditarUser(int num_user, String user1) {
        usuario1 = user1;
        initComponents();
        CargarDatos(num_user);
    }
    ...
    private void initComponents() {
        ...
        txtTipoUs.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        String tipo = txtTipoUs.getText();
        
        control.EditarUsuario(user,usuario,tipo);
        
         DatosAdm datosad = new DatosAdm(this.usuario1);
        this.dispose();
        
       
        datosad.setVisible(true);
        datosad.setLocationRelativeTo(null);
    ...
    private void CargarDatos(int num_user) {
      user=control.TraerUsuario(num_user);
        
      txtTipoUs.setText(user.getTipo());
